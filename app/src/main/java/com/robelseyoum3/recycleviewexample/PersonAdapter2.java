...
public class PersonAdapter2 extends RecyclerView.Adapter<PersonAdapter2.PersonViewHolder> {

    private ArrayList<Person> personArrayList;
    private onPersonClickListener listener;

    public PersonAdapter2(ArrayList<Person> personArrayList, onPersonClickListener onPersonClickListener) {
